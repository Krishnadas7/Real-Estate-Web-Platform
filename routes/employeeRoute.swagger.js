 ...
 *     description: Retrieve a list of employees with optional filtering, searching, and pagination
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *         schema:
 *           type: string
 *         description: Search term for name, email, phone, or internal ID
 *       - in: query
 *         name: role
 *         schema:
 *           type: string
 ...
 *     description: Retrieve comprehensive statistics about employees including counts by role, status, and monthly trends
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *                 message:
 *                   type: string
 *                   example: "Employee statistics fetched successfully"
 *                 data:
 ...
 *     description: Update an employee's active/inactive status
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     description: Reset an employee's password with a new password provided by the admin
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *                 message:
 *                   type: string
 *                   example: "Employee password reset successfully"
 *                 data:
 *                   type: object
 *                   properties:
 *                     _id:
 ...
 *     description: Delete an employee permanently
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *           example:
 *             employeeIds: ["64f1a2b3c4d5e6f7g8h9i0j1", "64f1a2b3c4d5e6f7g8h9i0j2", "64f1a2b3c4d5e6f7g8h9i0j3"]
 *     responses:
 *       200:
 ...
 *                 message:
 *                   type: string
 *                   example: "3 employees deleted successfully"
 *                 data:
 *                   type: object
 *                   properties:
 *                     deletedCount:
 ...
 *                       example: 3
 *       400:
 *         description: Invalid employee IDs or validation error
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ValidationError'
